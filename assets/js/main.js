(function ($) {
  ...
  $offCanvasNavSubMenu
    .parent()
    .prepend(
      '<span class="menu-expand"><svg class="w-6 h-6 icon-16" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.7911 1.0474C15.5023 0.741097 15.0192 0.729691 14.7145 1.01768L7.99961 7.37897L1.28555 1.01772C0.980773 0.728941 0.498472 0.741128 0.208947 1.04743C-0.080577 1.35296 -0.0676398 1.83526 0.237916 2.12478L7.47618 8.98209C7.62246 9.12077 7.81143 9.19087 7.99961 9.19087C8.18779 9.19087 8.37751 9.12077 8.52382 8.98209L15.7621 2.12478C16.0676 1.83523 16.0806 1.35296 15.7911 1.0474Z" fill="#181A1F"/></svg></span>'
    );
  ...
  $(document).on("click", function (event) {
    ...
    if (
      ...
      !$triggerSearch.has(event.target).length
    ) {
  ...
  $(".form-comment input, .form-comment textarea, .form-comment select").focus(
    function () {
      $(this).parents(".form-group").addClass("focused");
    }
  );

  $(".form-comment input, .form-comment textarea, .form-comment select").blur(
    function () {
  ...
  $(".form-comment input, .form-comment textarea, .form-comment select").each(
    function () {
      if (this.value) {
        $(this).parents(".form-group").addClass("focused");
        $(this).addClass("filled");
...
function initSwiperTestimonials(
  ...
  var swiper_1_items = new Swiper(id_class, {
    ...
    onAny(eventName, ...args) {
      if (
        eventName == "slidePrevTransitionEnd" ||
        eventName == "slideNextTransitionEnd"
      ) {
...
if ($(".swiper-group-testimonials-2").length > 0) {
  initSwiper1Iem(
    ".swiper-group-testimonials-2",
    ".swiper-button-next-testimonials-2",
    ".swiper-button-prev-testimonials-2",
    ".swiper-pagination-testimonials-2",
    "fraction"
  );
}
if ($(".swiper-group-testimonials-fraction").length > 0) {
  initSwiper1Iem(
    ".swiper-group-testimonials-fraction",
    ".swiper-button-next-testimonials-fraction",
    ".swiper-button-prev-testimonials-fraction",
...
let navIcon = document.querySelector("#mobile-navbar-icon");
let subHeader = document.querySelector(".subheader-mobile");
...
navIcon.addEventListener("click", () => {
  ...
  if (window.innerWidth <= 768) {
    subHeader.style.display =
      subHeader.style.display === "flex" || subHeader.style.display === ""
        ? "none"
        : "flex";
  }

  body.style.overflowY =
    body.style.overflowY == "scroll" || body.style.overflowY == ""
      ? "hidden"
      : "scroll";
});
